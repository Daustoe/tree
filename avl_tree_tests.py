...
class ComplexTreeTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_least(self):
        self.assertEqual(self.tree.least(), 9)
...
class TreeTests(unittest.TestCase):
    ...
    def test_singleton_creation(self):
        temp_tree = avl_tree.AvlTree(cargo=1)
        self.assertEqual(len(temp_tree), 1)
        self.assertListEqual([1], temp_tree.traverse('cargo'))
    ...
    def test_least_singleton(self):
        self.assertEqual(self.tree.least(), None)
        self.tree.insert(1)
        self.assertEqual(self.tree.least(), 1)

    def test_greatest_singleton(self):
        self.assertEqual(self.tree.greatest(), None)
        self.tree.insert(1)
        self.assertEqual(self.tree.greatest(), 1)
